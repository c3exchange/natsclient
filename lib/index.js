...
class Client extends node_events_1.EventEmitter {
    ...
    static create(opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Connect to server
            const conn = yield nats.connect(Object.assign(Object.assign({ servers, debug: opts.debug }, auth), { maxReconnectAttempts: -1, reconnectTimeWait: 500, timeout: 10000, name: opts.name, noEcho: opts.enableEcho ? false : true, tls }));
            // Get stream mamanger
    ...
    constructor(_name, conn, jsm) {
        ...
        this.conn = conn;
        this.jsm = jsm;
        this.internals = new internals_1.SharedInternals();
    ...
    createKvBucket(name, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const createBucketOptions = Object.assign({ streamName: 'KV_' + name, codec: (0, internals_1.NoopKvCodecs)(), allow_direct: false, max_bytes: (opts && opts.maxStorageSizeInBytes) ? opts.maxStorageSizeInBytes : 1024 * 1024, maxBucketSize: (opts && opts.maxStorageSizeInBytes) ? opts.maxStorageSizeInBytes : 1024 * 1024 }, (opts && Object.assign(Object.assign(Object.assign(Object.assign({}, (opts.description && opts.description.length > 0 && {
                description: opts.description
